          ...
          cards: [
            {
              ...
              icon: "➕",
              link: "/instructor/create-session",
              color: "blue",
            },
            {
              title: "My Sessions",
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {content.cards.map((card, index) => (
          <button
            ...
            className={`text-white rounded-2xl shadow-lg p-8 transition-all transform hover:scale-105 bg-gradient-to-br ${getColorClasses(
              card.color
            )}`}
          >
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
        ...
        <p className="text-yellow-700">
          Dashboard features are being implemented. Check back soon!
        </p>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              <tr className="border-t">
                <td className="py-3">Aman Kumar</td>
                <td className="py-3">Present</td>
                <td className="py-3">2025-10-18</td>
              </tr>
              <tr className="border-t">
                <td className="py-3">Sumit</td>
